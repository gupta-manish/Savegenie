 ...
 */
public class SubTypeFilterAdapter extends ArrayAdapter<Integer>
{
    private Context context;
    LayoutInflater layInf;
    private ArrayList<SubType> brandList;
    private int[] check;
    InternetURL urlHandler = new InternetURL();;
    public SubTypeFilterAdapter(Context context, Integer[] itemId,
                                ArrayList<SubType> brandList) {
