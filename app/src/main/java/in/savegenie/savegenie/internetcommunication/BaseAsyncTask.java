...
public abstract class BaseAsyncTask<ResponseType> extends AsyncTask<String, Integer, ResponseType>
{
    ...
    abstract UrlEncodedFormEntity getUrlEncodedFormEntity(String... params) throws UnsupportedEncodingException;
