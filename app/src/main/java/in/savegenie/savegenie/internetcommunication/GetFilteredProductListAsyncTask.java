 ...
 */
public class GetFilteredProductListAsyncTask extends BasicAsyncTask<ProductListResponse>
{

    @Override
    String getUrlLink()
    {
        return InternetURL.GET_FILTERED_PRODUCT_LIST;
    }

    @Override
    void addPostData(String... params)
    {
        addDataToPostVariable("data[mastcatids]","0-"+params[0]);
        addDataToPostVariable("data[resultcount]",params[1]);
    }
