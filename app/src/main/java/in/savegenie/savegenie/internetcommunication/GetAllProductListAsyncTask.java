 ...
 */
public class GetAllProductListAsyncTask extends BasicAsyncTask<ProductListResponse>
{

    @Override
    String getUrlLink()
    {
        return InternetURL.GET_ALL_PRODUCT_LIST;
    }
